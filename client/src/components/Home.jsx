...
function Home() {
  return (
    <div className='grid grid-cols-2 gap-4 items-center w-full '>
      <div className='flex flex-col h-screen w-full  rounded-lg items-center '>
        ...
        <div className='flex w-full h-screen  gap-11 items-center justify-center'>
         <Link to="about" ><button className='text-white bg-[#022c22] p-3 w-[130px] rounded-full font-bold hover:bg-[#f59e0b] hover:text-inherit'>Learn more</button></Link> 
         <Link to="dashboard"> <button className='text-inherit bg-[#f59e0b] p-3 w-[130px] rounded-full font-bold hover:bg-[#022c22] hover:text-white'>Dashboard</button></Link>
        </div>
